...
<div class="row">
    <div class="col-md-4 mb-3">
        ...
        <input type="text" name="first_name" pattern="[a-z]{1,15}" class="form-control" id="validationTooltip01"
    ...
    <div class="col-md-4 mb-3">
        ...
        <input type="text" name="last_name" class="form-control" id="validationTooltip02"
            placeholder="Last name" value="{{ $passport->last_name  ?? '' }}" required>
    ...
    <div class="col-md-4 mb-3">
        ...
        <div class="input-group">
            <input type="text" id="date_of_birth" name="date_of_birth"  value="{{ $passport->date_of_birth  ?? '' }}" class="form-control datepicker_old"
...
<div class="row">
    ...
    <div class="col-md-3 mb-3">
        ...
        <input type="text" id="country_selector" value="{{ $passport->country_selector  ?? '' }}" class="form-control" name="place_of_birth"
    ...
    <div class="col-md-3 mb-3">
        ...
        <input type="text" id="country_of_residency" value="{{ $passport->country_of_residency  ?? '' }}" name="country_of_residency"
            class="form-control" required>
...
<div class="row">
    <div class="col-md-3 mb-3">
        ...
        <input type="text" name="profession" value="{{ $passport->profession  ?? '' }}"  class="form-control" placeholder="Profession">
        <div class="invalid-feedback"> Please write Profession.</div>
        <div class="valid-feedback"> {{ $success_check }} </div>
    </div>
    <div class="col-md-3 mb-3">
        <label for="validationTooltip04"> Organization (optional)</label>
        <input type="text" name="organization"  value="{{ $passport->organization  ?? '' }}"   class="form-control" id="validationTooltip04"
...
<div class="row">
    <div class="col-md-6 mb-3">
        ...
        <input type="text" name="passport_no" minlength="6" class="form-control"
            id="validationTooltip03" placeholder="123456" value="{{ $passport->passport_no  ?? '' }}"  required>
    ...
    <div class="col-md-3 mb-3">
        ...
        <input type="text" id="expiry_date" name="expiry_date"  value="{{ $passport->expiry_date  ?? '' }}"  class="form-control datepicker_new" 
            id="validationTooltip03" placeholder="" required>
...
<div class="row">
    ...
    <div class="col-md-3 mb-3">
        ...
        <input type="text" id="place_of_issue" value="{{ $passport->place_of_issue  ?? '' }}" name="place_of_issue" class="form-control"
...
<div class="row">
    ...
    <div class="col-md-4 mb-3">
        ...
        class="form-control datepicker_new"
    ...
    <div class="col-md-4 mb-3">
        ...
        <input type="number" min="01" max="90" name="visa_duration"
            class="form-control" id="validationTooltip04"  value="{{ $passport->visa_duration  ?? '' }}"  placeholder="" required>
