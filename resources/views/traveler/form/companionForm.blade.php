...
<div class="row">
    ...
    <div class="col-md-4 mb-3">
        ...
        <div class="input-group">
            <input type="text" id="comp_date_of_birth" name="comp_date_of_birth"
                class="form-control comp_input datepicker" id="validationTooltipUsername" placeholder=" "
...
<div class="row">
    <div class="col-md-4 mb-3">
        ...
        <select type="text" name="comp_gender" class="form-control comp_input" id="validationTooltipUsername">
...
<div class="row">
    ...
    <div class="col-md-3 mb-3">
        ...
        <input type="text" id="comp_expiry_date" name="comp_expiry_date"
            class="form-control comp_input datepicker_old" id="validationTooltip03" placeholder="">
...
<div class="row">
    <div class="col-md-4 mb-3">
        ...
        <input type="text" id="comp_arrival_date" name="comp_arrival_date"
            class="form-control comp_input datepicker_new" placeholder=" ">
...
<div class="row">
    <div class="col-md-6 mb-3">
        ...
        <input type="file" name="comp_passport_picture" class="form-control comp_input" id="validationTooltip03"
            placeholder=" ">
    ...
    <div class="col-md-6 mb-3">
        ...
        <input type="file" name="comp_personal_picture" class="form-control comp_input" id="validationTooltip03"
            placeholder=" ">
