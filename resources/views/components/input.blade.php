@if ($type == 'text')
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            ...
            <input value="{!! $value ?? '' !!}" placeholder="{!! $placeholder ?? 'Name' !!}" class="form-control"
                name="{!! $nameInDb ?? 'name' !!}" type="text">
        </div>
    </div>
...
@elseif ($type == 'select')
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            ...
            <select name="roles[]" id="select-state" class="form-control select" multiple>
            ...
            <select name="{{ $nameInDb ?? 'name' }}" id="select-state" class="form-control" <?php
            if ($nameInDb == 'roles') {
                echo 'multiple';
            } ?> >
                <option value="">Select ...</option>
