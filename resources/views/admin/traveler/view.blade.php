                    ...
                    <div class="card-body"> 
                        ...
                        @if ($traveler->status == 'pending')
                            <a href="{{ route('traveler.processing', $traveler->id) }}"
                                class="mx-3 btn btn-info align-items-center" data-bs-toggle="tooltip" title="processing">
                                processing
                            </a>
                            <a href="{{ route('traveler.completed', $traveler->id) }}"
                                class="mx-3 btn btn-success align-items-center" data-bs-toggle="tooltip" title="completed">
                                completed
                            </a>
